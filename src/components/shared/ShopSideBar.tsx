...
const ShopSideBar: React.FC<ShopSideBarProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm p-6 space-y-6 sticky top-24 transition-colors">
        ...
        <div className="space-y-1.5">
          <button
            ...
            className={`w-full flex items-center justify-between px-3.5 py-2.5 text-xs font-medium rounded-xl transition-all ${
              selectedSort === null
                ? "bg-[#81ba00] text-white shadow-xs font-bold"
