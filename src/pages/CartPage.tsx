        ...
        {items.length > 0 ? (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-8 space-y-4">
              <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden divide-y divide-slate-100 dark:divide-slate-800 transition-colors">
                <div className="p-5 flex items-center justify-between bg-slate-50/70 dark:bg-slate-800/50">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="space-y-1">
                        <NavLink
                          ...
                          className="text-sm sm:text-base font-bold text-slate-800 dark:text-slate-100 hover:text-[#81ba00] transition-colors"
                        >
                          {item.name}
                        </NavLink>
                    ...
                    <div className="flex items-center justify-between w-full sm:w-auto gap-6 sm:gap-8">
                      ...
                      <div className="flex items-center border border-slate-200 dark:border-slate-700 rounded-xl p-1 bg-white dark:bg-slate-800">
                        <button
                          ...
                          className="w-7 h-7 rounded-lg flex items-center justify-center text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700"
                        >
                          <Minus size={13} />
                        </button>
              ...
              <div className="pt-2">
                <NavLink
                  to="/shop"
                  className="inline-flex items-center gap-2 text-xs font-bold text-slate-600 dark:text-slate-300 hover:text-[#81ba00] transition-colors"
                >
            ...
            <div className="lg:col-span-4 space-y-4 sticky top-24">
              <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm p-6 space-y-6 transition-colors">
                <h3 className="text-base font-extrabold text-slate-800 dark:text-slate-100 border-b border-slate-100 dark:border-slate-800 pb-4">
                  Order Summary
                </h3>
                ...
                <form onSubmit={handleApplyPromo} className="space-y-2">
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-grow text-xs uppercase px-3 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-slate-100 focus:outline-hidden focus:border-[#81ba00] disabled:bg-slate-100 dark:disabled:bg-slate-800/40"
                    />
                    <Button
                      type="submit"
                      variant="outline"
                      disabled={promoApplied || !promoCode.trim()}
                      className="text-xs font-bold rounded-xl dark:border-slate-700 dark:text-slate-200"
                    >
                      Apply
                    </Button>
                  </div>
                ...
                <div className="space-y-3 text-xs sm:text-sm text-slate-600 dark:text-slate-300">
                  ...
                  <div className="border-t border-slate-100 dark:border-slate-800 pt-3 flex justify-between items-baseline text-base sm:text-lg font-extrabold text-slate-800 dark:text-slate-100">
                ...
                {/* Trust Badges */}
                <div className="pt-2 border-t border-slate-100 dark:border-slate-800 flex items-center justify-center gap-6 text-[11px] text-slate-400 font-medium">
                  <span className="flex items-center gap-1">
                    <ShieldCheck size={14} className="text-emerald-600 dark:text-emerald-400" /> SSL Encrypted
                  </span>
                  <span className="flex items-center gap-1">
                    <Truck size={14} className="text-emerald-600 dark:text-emerald-400" /> Plant Safe Delivery
                  </span>
                </div>
              </div>
            </div>
